  ...
  return (
    <Layout variant="dark" showFooter={false}>
      ...
      <div className="bg-white p-6 rounded-xl shadow-lg border-4 border-purple-900 space-y-4">
        ...
        {/* Microsoft Copilot Card (Internal to the main card) - NOW WRAPPED IN LINK TO THE NEW PUBLIC PAGE */}
        <Link to="/public-copilot" className="block w-full no-underline">
          <div className="bg-gray-100 p-4 rounded-lg flex justify-between items-center border border-gray-300 hover:bg-gray-200 transition-colors cursor-pointer">
            <div>
              <h4 className="text-lg font-bold text-purple-900">
                MICROSOFT COPILOT
              </h4>
              <p className="text-sm text-purple-600 font-semibold">
                Your Everyday AI Assistant. Click to Chat!
              </p>
            </div>
